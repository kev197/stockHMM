...
Use yfinance to fetch stock data and the ta to compute technical indicators. Define the observation vector as a list of preprocessed stock attributes and indicators. 
